...
void Group::ajoutTransformationsGroupePrimitive(Primitive *p_primitive)
{
	...
	// Rotation 
	p_primitive->Rotate(p_primitive->GetRotationX() + this->RotateX, p_primitive->GetRotationY() + this->RotateY, p_primitive->GetRotationZ() + this->RotateZ);
	// Dimension
...
void Group::ajoutTransformationsGroupeForme(Form *p_form)
{
	...
	// Rotation 
	p_form->Rotate(p_form->GetRotationX() + this->RotateX, p_form->GetRotationY() + this->RotateY, p_form->GetRotationZ() + this->RotateZ);
	// Dimension
...
void Group::ajoutTransformationsGroupeGroupe(Group *p_group)
{
	...
	// Rotation 
	p_group->Rotate(p_group->GetRotationX() + this->RotateX, p_group->GetRotationY() + this->RotateY, p_group->GetRotationZ() + this->RotateZ);
	// Dimension
